...
class Sorular {
  ...
  static final List<SoruKonusu> konular = <SoruKonusu>[
    ...
    const SoruKonusu(
      ...
      renk: Color(0xFF7A5C2E),
      sorular: <String>[
        '1950’li yıllar aklınızda nasıl kaldı? O günlerde hayat nasıldı?',
        '1960’lı yıllar sizin için nasıl geçti?',
        '1970’li yıllarınız nasıldı? O günleri anlatır mısınız?',
        '1980’li yıllar nasıldı? Sizin için neler değişti?',
        '1990’lı yıllar nasıl geçti, neleri hatırlıyorsunuz?',
        '2000’li yıllara girerken neler hissettiniz?',
        'Eve ilk televizyon geldiği günü hatırlıyor musunuz?',
        'İlk telefonunuz nasıl bir şeydi? Kimlerle konuşurdunuz?',
        'Gençliğinizdeki dünyayla bugünü karşılaştırsanız en çok ne değişti?',
        'Hayatınız boyunca gördüğünüz en büyük değişiklik neydi?',
        'Eskiden komşuluk nasıldı? Bugünden farkı neydi?',
        'O yıllarda çarşı pazar nasıldı, alışveriş nasıl yapılırdı?',
        'Hangi yıllara geri dönmek isterdiniz? Neden?',
        'Unutamadığınız bir gün var mı? O gün ne olmuştu?',
      ],
    ),
    const SoruKonusu(
      ad: 'Keşkeler',
      ikon: Icons.self_improvement_rounded,
      renk: Color(0xFF7B5E57),
      sorular: <String>[
        'Pişmanlıklarınız var mı? “Keşke” dediğiniz bir şey oldu mu?',
        'Geri alabileceğiniz tek bir karar olsa hangisi olurdu?',
        'Yapmayı çok istediğiniz ama bir türlü yapamadığınız ne oldu?',
        'Gitmek isteyip de gidemediğiniz bir yer var mı?',
        'Söylemek isteyip söyleyemediğiniz bir söz kaldı mı? Kime?',
        'Affettiğiniz biri var mı? Peki affedemediğiniz?',
        'Bugün olsa farklı yapardım dediğiniz bir şey var mı?',
        'Kaçırdığınızı düşündüğünüz bir fırsat oldu mu?',
        'İyi ki yaptım, hiç pişman olmadım dediğiniz şey nedir?',
        'Torunlarınız aynı şeye pişman olmasın diye ne söylersiniz?',
      ],
    ),
    const SoruKonusu(
      ad: 'Bugün',
